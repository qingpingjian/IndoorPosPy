...
if __name__ == "__main__":
    ...
    jcd360Axe.plot(jcd360n5DiffArray[:, 0], jcd360n5DiffArray[:, 2], "g-.", linewidth=2, label="$Minimum\ on\ Different\ Segments$")
    jcd360Axe.plot(jcd360n5SameArray[:, 0], jcd360n5SameArray[:, 1], "b--", linewidth=2, label="$Maximum\ on\ Same\ Segment$")
    ...
    jcd360Axe.set_ylabel("$Similarity$", fontdict=firstFont)
    ...
    jcd360Axe.grid(True)
    jcd360Axe.legend(loc=4, fontsize=tickFontSize)

    jcdOppoAxe = plt.subplot(312)
    jcdOppoAxe.plot(jcdOppoDiffArray[:, 0], jcdOppoDiffArray[:, 2], "g-.", linewidth=2, label="$Minimum\ on\ Different\ Segments$")
    jcdOppoAxe.plot(jcdOppoSameArray[:, 0], jcdOppoSameArray[:, 1], "b--", linewidth=2, label="$Maximum\ on\ Same\ Segment$")
    ...
    jcdOppoAxe.set_ylabel("$Similarity$", fontdict=firstFont)
    ...
    jcdXiaomiAxe.plot(jcdXiaomiDiffArray[:, 0], jcdXiaomiDiffArray[:, 2], "g-.", linewidth=2, label="$Minimum\ on\ Different\ Segments$")
    jcdXiaomiAxe.plot(jcdXiaomiSameArray[:, 0], jcdXiaomiSameArray[:, 1], "b--", linewidth=2, label="$Maximum\ on\ Same\ Segment$")
    ...
    jcdXiaomiAxe.set_ylabel("$Similarity$", fontdict=firstFont)
    ...
    jcdXiaomiAxe.legend(loc=4, fontsize=tickFontSize)
    plt.show()
    print("Done.")