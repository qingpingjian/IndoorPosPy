...
if __name__ == "__main__":
    ...
    jcd360Axe.fill_between(jcd360n5SameArray[:, 0], jcd360n5SameArray[:, 1], jcd360n5SameArray[:, 2], alpha=0.35, hatch="\\", edgecolor="black", label="$Same\ Paths$")
    ...
    jcd360Axe.fill_between(jcd360n5DiffArray[:, 0], jcd360n5DiffArray[:, 1], jcd360n5DiffArray[:, 2], alpha=0.35, hatch="/", edgecolor="black", label="$Different\ Paths$")
    ...
    jcd360Axe.set_title("$360\ N5\ vs.\ 360\ N5$", fontdict=firstFont)
    plt.xticks(fontsize=tickFontSize)
    plt.yticks(fontsize=tickFontSize)
    jcd360Axe.set_xlim(0, 45)
    jcd360Axe.set_ylim(0.3, 1.0)
    jcd360Axe.grid(True)
    jcd360Axe.legend(loc="best", fontsize=tickFontSize)
    ...
    jcdOppoAxe.fill_between(jcdOppoSameArray[:, 0], jcdOppoSameArray[:, 1], jcdOppoSameArray[:, 2], alpha=0.35, hatch="\\", edgecolor="black", label="$Same\ Paths$")
    ...
    jcdOppoAxe.fill_between(jcdOppoDiffArray[:, 0], jcdOppoDiffArray[:, 1], jcdOppoDiffArray[:, 2], alpha=0.35, hatch="/", edgecolor="black", label="$Different\ Paths$")
    ...
    jcdOppoAxe.set_title("$360\ N5\ vs.\ OPPO\ R827T$", fontdict=firstFont)
    plt.xticks(fontsize=tickFontSize)
    plt.yticks(fontsize=tickFontSize)
    jcdOppoAxe.set_xlim(0, 40)
    jcdOppoAxe.set_ylim(0.3, 1.0)
    jcdOppoAxe.grid(True)
    jcdOppoAxe.legend(loc="best", fontsize=tickFontSize)
    ...
    jcdXiaomiAxe.fill_between(jcdXiaomiSameArray[:, 0], jcdXiaomiSameArray[:, 1], jcdXiaomiSameArray[:, 2], alpha=0.35, hatch="\\", edgecolor="black", label="$Same\ Paths$")
    ...
    jcdXiaomiAxe.fill_between(jcdXiaomiDiffArray[:, 0], jcdXiaomiDiffArray[:, 1], jcdXiaomiDiffArray[:, 2], alpha=0.35, hatch="/", edgecolor="black", label="$Different\ Paths$")
    ...
    jcdXiaomiAxe.set_title("$360\ N5\ vs.\ Xiaomi\ 3W$", fontdict=firstFont)
    plt.xticks(fontsize=tickFontSize)
    plt.yticks(fontsize=tickFontSize)
    jcdXiaomiAxe.set_xlim(0, 40)
    jcdXiaomiAxe.set_ylim(0.3, 1.0)
    jcdXiaomiAxe.grid(True)
    jcdXiaomiAxe.legend(loc="best", fontsize=tickFontSize)
    plt.show()
    print("Done.")