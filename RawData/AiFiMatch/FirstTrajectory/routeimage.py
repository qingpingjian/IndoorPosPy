...
if __name__ == "__main__":
    ...
    realLocFilePath = "20180302213910_route.csv"
    estiLocFilePath = "20180302213910_estimate_pdr.csv"
    offlineLocFilePath = "20180302213910_estimate_aifi_offline_0315.csv"
